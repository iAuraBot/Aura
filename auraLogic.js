...
const NEGATIVE_FLAVORS = [
  ...
  '🧠 NEGATIVE RIZZ detected! You\'re in your FLOP era!',
...
const JACKPOT_FLAVORS = [
  ...
  '🎉 HOLY SIGMA! This farm is bonkers AF!',
  '🕺 SKIBIDI BOP YES YES! Your grindset just went NUCLEAR!',
...
const DUEL_WIN_FLAVORS = [
  ...
  '🕺 {winner} hit the GRIDDY on {loser}\'s aura! SKIBIDI MOMENT!',
  '🫵😹 {loser} really thought they could mog {winner}? GOOFY AHH move frfr!',
  '🎯 {winner} is the BIGGEST BIRD! {loser} got sent to OHIO!',
...
const BLESSING_FLAVORS = [
  ...
  '💫 LEGENDARY SHARE! This energy is ASCENDED!',
  '🎭 GYATT! That blessing was absolutely BUSSIN AF!',
  '🕺 GENEROUS AF! You\'re hittin the GRIDDY of kindness!',
